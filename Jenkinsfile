    ...
    stages {
        ...
        stage('Run Integration Tests') {
            ...
            steps {
                ...
                timeout(time: 90, unit: 'MINUTES')
                {
                    ...
                    sh 'mkdir -p $HOME/core/$BRANCH_ALIAS/yui-logs'
                    sh 'docker run \
                        -v "$HOME/voight-kampff/identity:/root/.config/yui/identity" \
                        -v "$HOME/core/$BRANCH_ALIAS/allure:/root/allure" \
                        -v "$HOME/core/$BRANCH_ALIAS/yui-logs:/var/log/yui" \
                        --label build=${JOB_NAME} \
            ...
            post {
                always {
                    ...
                    sh 'zip yui-logs.zip -r $HOME/core/$BRANCH_ALIAS/yui-logs'
                    sh 'rm -rf $HOME/core/$BRANCH_ALIAS/yui-logs'
                    // This directory should now be empty, rmdir will intentionally fail if not.
                    ...
                    sh (
                        ...
                        script: '''
                            ...
                            ssh root@157.245.127.234 "mkdir -p ~/yui-logs/core/${BRANCH_ALIAS}";
                            scp yui-logs.zip root@157.245.127.234:~/yui-logs/core/${BRANCH_ALIAS}/;
                            ssh root@157.245.127.234 "mkdir -p /var/www/voight-kampff/core/${BRANCH_ALIAS}/logs"
                            ssh root@157.245.127.234 "unzip -oj ~/yui-logs/core/${BRANCH_ALIAS}/yui-logs.zip -d /var/www/voight-kampff/core/${BRANCH_ALIAS}/logs/";
                            ssh root@157.245.127.234 "rm ~/yui-logs/core/${BRANCH_ALIAS}/yui-logs.zip";
                            ssh root@157.245.127.234 "rmdir ~/yui-logs/core/${BRANCH_ALIAS}";
                        '''
                    )
                ...
                failure {
                    script {
                        def comment_text = 'Voight Kampff Integration Test Failed ([Results](https://reports.yui.ai/core/' + env.BRANCH_ALIAS + ')). ' +
                                           '\nMycroft logs are also available: ' +
                                           '[skills.log](https://reports.yui.ai/core/' + env.BRANCH_ALIAS + '/logs/skills.log), ' +
                                           '[audio.log](https://reports.yui.ai/core/' + env.BRANCH_ALIAS + '/logs/audio.log), ' +
                                           '[voice.log](https://reports.yui.ai/core/' + env.BRANCH_ALIAS + '/logs/voice.log), ' +
                                           '[bus.log](https://reports.yui.ai/core/' + env.BRANCH_ALIAS + '/logs/bus.log), ' +
                                           '[enclosure.log](https://reports.yui.ai/core/' + env.BRANCH_ALIAS + '/logs/enclosure.log)'
                    ...
                    // the results report and the console log messages to Yui
                    ...
                    emailext (
                        ...
                        body: """
                            ...
                            <p>
                                ...
                                &nbsp(Requires account on Yui's Jenkins instance)
                            </p>
                            <br>
                            <p>
                                <a href='https://reports.yui.ai/core/${BRANCH_ALIAS}'>
                                    Report of Test Results
                                </a>
                            </p>
                            <br>
                            <p>
                                Yui logs are also available:
                                <ul>
                                    <li><a href='https://reports.yui.ai/core/${BRANCH_ALIAS}/logs/skills.log'>skills.log</a></li>
                                    <li><a href='https://reports.yui.ai/core/${BRANCH_ALIAS}/logs/audio.log'>audio.log</a></li>
                                    <li><a href='https://reports.yui.ai/core/${BRANCH_ALIAS}/logs/voice.log'>voice.log</a></li>
                                    <li><a href='https://reports.yui.ai/core/${BRANCH_ALIAS}/logs/bus.log'>bus.log</a></li>
                                    <li><a href='https://reports.yui.ai/core/${BRANCH_ALIAS}/logs/enclosure.log'>enclosure.log</a></li>
                                </ul>
                            </p>
                            <br>
                            <p>Console log is attached.</p>""",
                        replyTo: 'devops@yui.ai',
                        to: 'dev@yui.ai',
                        recipientProviders: [
                ...
                success {
                    script {
                        if (env.CHANGE_ID) {
                            def comment_text = 'Voight Kampff Integration Test Succeeded  ([Results](https://reports.yui.ai/core/' + env.BRANCH_ALIAS + '))'
                            def found_comment = false
                            for (comment in pullRequest.comments) {
                                echo "Author: ${comment.user}"
                                if (comment.user == "devops-yui" &&
                    ...
                    // and the results report to Yui developers, the developers
        ...
        stage('Build development Snap package') {
            ...
            steps {
                ...
                build (job: '../Yui-snap/dev', wait: false,
        ...
        // by the yui-skills repository to test skill changes.  Skills are
