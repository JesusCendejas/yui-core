...
from yui.util import wait_for_exit_signal, reset_sigint_handler
...
def create_enclosure(platform):
    ...
    if platform == "mycroft_mark_1":
        ...
        from yui.client.enclosure.mark1 import EnclosureMark1
        enclosure = EnclosureMark1()
    elif platform == "mycroft_mark_2":
        LOG.info("Creating Mark II Enclosure")
        from yui.client.enclosure.mark2 import EnclosureMark2
        ...
        # the yui.conf, then load/launch that script.
        from yui.client.enclosure.generic import EnclosureGeneric
