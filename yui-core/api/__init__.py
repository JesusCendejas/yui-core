...
from yui.identity import IdentityManager, identity_lock
from yui.version import VersionManager
from yui.util import get_arch, connected, LOG
...
def is_paired(ignore_errors=True):
    ...
    Determines if the installation of Yui has been paired by the user
