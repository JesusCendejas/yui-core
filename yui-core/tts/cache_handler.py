...
yui responses) and does a tts inference.
...
MIMIC2_URL = 'https://mimic-api.yui.ai/synthesize?text='
...
res_path = os.path.abspath(os.path.join(os.path.abspath(__file__), '..',
                                        '..', 'res', 'text', 'en-us'))
wifi_setup_path = '/usr/local/yui/yui-wifi-setup/dialog/en-us'
...
def generate_cache_text(cache_audio_dir, cache_text_file):
    ...
    yui/res/text/en-us and yui-wifi setup skill
    Args:
