...
It's important to note that this requires this test to run yui service
...
class TestMessagebusMethods(unittest.TestCase):
    ...
    def setUp(self):
        ...
        This requires starting the yui service and creating two
        WebsocketClient object to talk with eachother.  Not this is
        threaded and will require cleanup
        """
        # start the yui service. and get the pid of the script.
        self.pid = Popen(["python3", "-m", "yui.messagebus.service"]).pid
    ...
    def tearDown(self):
        ...
        yui service that was started in setUp.
        """
        self.ws1.close()
        self.ws2.close()
