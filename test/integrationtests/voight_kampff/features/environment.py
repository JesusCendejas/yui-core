...
class InterceptAllBusClient(MessageBusClient):
    ...
    def on_message(self, _, message):
        ...
        Args:
            message (Message): message from the Yui bus
        """
...
def before_all(context):
    ...
    start = monotonic()
    while True:
        response = bus.wait_for_response(Message('yui.skills.all_loaded'))
...
def after_scenario(context, scenario):
    """Wait for yui completion and reset any changed state."""
