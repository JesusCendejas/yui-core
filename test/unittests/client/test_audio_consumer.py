...
from yui.client.speech.listener import (AudioConsumer, RecognizerLoop,
                                            AUDIO_DATA, STREAM_START,
                                            STREAM_DATA, STREAM_STOP)
from yui.stt import MycroftSTT
...
class AudioConsumerTest(unittest.TestCase):
    ...
    def test_word_extraction(self):
        """
        This is intended to test the extraction of the word: ``yui``.
    ...
    def test_wakeword(self):
        self.queue.put((AUDIO_DATA,
                        self.__create_sample_from_test_file('yui')))
