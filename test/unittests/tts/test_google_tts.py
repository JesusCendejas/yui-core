...
from yui.tts.google_tts import GoogleTTS, GoogleTTSValidator
import yui.tts.google_tts as google_tts_mod


@mock.patch('yui.tts.google_tts.gTTS')
...
class TestGoogleTTS(unittest.TestCase):
    ...
    @mock.patch('yui.tts.google_tts.tts_langs')
