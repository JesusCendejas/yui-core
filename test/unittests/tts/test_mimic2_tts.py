...
@mock.patch('yui.tts.mimic2_tts.FuturesSession')
...
class TestMimic2(unittest.TestCase):
    def test_get_tts(self, _, mock_session):
        ...
        with mock.patch('yui.tts.mimic2_tts.open') as mock_open:
    ...
    @mock.patch('yui.tts.mimic2_tts.open')
    def test_phoneme_cache(self, mock_open, _, __):
        ...
        with mock.patch('yui.tts.mimic2_tts.json.load') as mock_load:
            read_phonemes = m2.load_phonemes('abc')
            self.assertEqual(read_phonemes, None)
            mock_load.reset_mock()
            with mock.patch('yui.tts.mimic2_tts.os.path.exists') as _:
