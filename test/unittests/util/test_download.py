...
from yui.util.download import (download, _running_downloads,
                                   _get_download_tmp)
from yui.util.file_utils import get_temp_path

TEST_URL = 'http://example.com/yui-test.tar.gz'
TEST_DEST = get_temp_path('file.tar.gz')


@mock.patch('yui.util.download.subprocess')
@mock.patch('yui.util.download.os')
...
@mock.patch('yui.util.download.glob')
