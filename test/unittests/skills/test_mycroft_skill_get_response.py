"""Tests for the yui skill's get_response variations."""
...
@mock.patch('yui.skills.mycroft_skill.mycroft_skill.Configuration')
...
class TestMycroftSkillGetResponse(TestCase):
    ...
    def test_get_response_no_dialog(self):
        ...
        self.assertEqual(sent_message.msg_type, 'yui.mic.listen')
