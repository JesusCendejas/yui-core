...
from yui.skills.intent_service import IntentService, _get_message_lang
from yui.skills.intent_services.adapt_service import (ContextManager,
                                                          AdaptIntent)
...
class ConversationTest(TestCase):
    ...
    def test_reset_converse(self):
        ...
        reset_msg = Message('yui.speech.recognition.unknown',
                            data={'lang': 'en-US'})
        self.intent_service.bus.wait_for_response.side_effect = response
