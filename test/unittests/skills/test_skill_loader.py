...
from yui.skills.skill_loader import _get_last_modified_time, SkillLoader
...
class TestSkillLoader(MycroftUnitTestBase):
    mock_package = 'yui.skills.skill_loader.'
    ...
    def test_skill_reload(self):
        ...
        self.assertListEqual(
            ['yui.skills.shutdown', 'yui.skills.loaded'],
