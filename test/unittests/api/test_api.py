...
yui.api.requests.post = MagicMock()
...
class TestApi(unittest.TestCase):
    def setUp(self):
        patcher = patch('yui.configuration.Configuration.get',
                        return_value=CONFIG)
        self.mock_config_get = patcher.start()
        self.addCleanup(patcher.stop)
        super().setUp()

    @patch('yui.api.IdentityManager.get')
    def test_init(self, mock_identity_get):
        mock_identity_get.return_value = create_identity('1234')
        a = yui.api.Api('test-path')
        self.assertEqual(a.url, 'https://api-test.yui.ai')
        self.assertEqual(a.version, 'v1')
        self.assertEqual(a.identity.uuid, '1234')

    @patch('yui.api.IdentityManager')
    @patch('yui.api.requests.request')
    def test_send(self, mock_request, mock_identity_manager):
        ...
        with self.assertRaises(yui.api.HTTPError):
            a.send(req)
        ...
        req = {'path': 'something', 'headers': {}}
        a.send(req)
        self.assertTrue(yui.api.IdentityManager.save.called)
...
class TestDeviceApi(unittest.TestCase):
    ...
    def test_device_get(self, mock_request, mock_identity_get):
        ...
        self.assertEqual(url, 'https://api-test.yui.ai/v1/device/1234')

    @patch('yui.api.IdentityManager.update')
    @patch('yui.api.IdentityManager.get')
    @patch('yui.api.requests.request')
    def test_device_get_code(self, mock_request, mock_identity_get,
        ...
        url = mock_request.call_args[0][1]
        self.assertEqual(
            url, 'https://api-test.yui.ai/v1/device/code?state=state')
    ...
    def test_device_get_settings(self, mock_request, mock_identity_get):
        ...
        url = mock_request.call_args[0][1]
        self.assertEqual(
            url, 'https://api-test.yui.ai/v1/device/1234/setting')
    ...
    def test_device_report_metric(self, mock_request, mock_identity_get):
        ...
        self.assertEqual(
            url, 'https://api-test.yui.ai/v1/device/1234/metric/mymetric')
    ...
    def test_device_send_email(self, mock_request, mock_identity_get):
        ...
        self.assertEqual(params['json'], correct_json)
        self.assertEqual(
            url, 'https://api-test.yui.ai/v1/device/1234/message')
    ...
    def test_device_get_oauth_token(self, mock_request, mock_identity_get):
        ...
        self.assertEqual(
            url, 'https://api-test.yui.ai/v1/device/1234/token/1')
    ...
    def test_device_get_location(self, mock_request, mock_identity_get):
        ...
        url = mock_request.call_args[0][1]
        self.assertEqual(
            url, 'https://api-test.yui.ai/v1/device/1234/location')
    ...
    def test_device_get_subscription(self, mock_request, mock_identity_get):
        ...
        url = mock_request.call_args[0][1]
        self.assertEqual(
            url, 'https://api-test.yui.ai/v1/device/1234/subscription')
    ...
    def test_device_upload_skills_data(self, mock_request, mock_identity_get):
        ...
        self.assertEqual(
            url, 'https://api-test.yui.ai/v1/device/1234/skillJson')
    ...
    def test_stt_stt(self, mock_request, mock_identity_get):
        ...
        url = mock_request.call_args[0][1]
        self.assertEqual(url, 'https://api-test.yui.ai/v1/stt')
    ...
    @patch('yui.api.IdentityManager.load')
    def test_has_been_paired(self, mock_identity_load):
        ...
        self.assertFalse(yui.api.has_been_paired())
        # Test empty string
        mock_identity.uuid = ""
        self.assertFalse(yui.api.has_been_paired())
        # Test actual id number
        mock_identity.uuid = "1234"
        self.assertTrue(yui.api.has_been_paired())
...
class TestSettingsMeta(unittest.TestCase):
    ...
    def test_upload_meta(self, mock_request, mock_identity_get):
        ...
        self.assertEqual(
            url, 'https://api-test.yui.ai/v1/device/1234/settingsMeta')
    ...
    def test_get_skill_settings(self, mock_request, mock_identity_get):
        ...
        self.assertEqual(
            url, 'https://api-test.yui.ai/v1/device/1234/skill/settings')


@patch('yui.api._paired_cache', False)
@patch('yui.api.IdentityManager.get')
@patch('yui.api.requests.request')
class TestIsPaired(unittest.TestCase):
    ...
    def test_is_paired_true(self, mock_request, mock_identity_get):
        ...
        self.assertTrue(yui.api.is_paired())
    ...
    def test_is_paired_false_local(self, mock_request, mock_identity_get):
        ...
        self.assertFalse(yui.api.is_paired())
        mock_identity.uuid = None
        self.assertFalse(yui.api.is_paired())
    ...
    def test_is_paired_error_remote(self, mock_request, mock_identity_get):
        ...
        with self.assertRaises(yui.api.BackendDown):
            yui.api.is_paired(ignore_errors=False)
