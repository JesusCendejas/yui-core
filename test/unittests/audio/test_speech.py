...
import yui.audio.speech as speech
from yui.messagebus import Message
from yui.tts.remote_tts import RemoteTTSTimeoutException
...
@mock.patch('yui.audio.speech.Configuration')
@mock.patch('yui.audio.speech.TTSFactory')
class TestSpeech(unittest.TestCase):
    def test_life_cycle(self, tts_factory_mock, config_mock):
        ...
        bus.on.assert_any_call('yui.stop', speech.handle_stop)
        bus.on.assert_any_call('yui.audio.speech.stop',
                               speech.handle_stop)
    ...
    @mock.patch('yui.audio.speech.Mimic')
    ...
    @mock.patch('yui.audio.speech.check_for_signal')
    ...
    def test_stop(self, check_for_signal_mock, tts_factory_mock, config_mock):
        ...
        speech.handle_stop(Message('yui.stop'))
