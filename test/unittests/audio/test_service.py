...
import yui.audio.audioservice as audio_service
...
class TestService(unittest.TestCase):
    ...
    @mock.patch('yui.audio.audioservice.load_services')
    ...
    def test_audio_service_track_start(self, mock_load_services):
        ...
        self.assertEqual(self.emitter.types, ['yui.audio.playing_track',
                                              'yui.audio.queue_end'])
