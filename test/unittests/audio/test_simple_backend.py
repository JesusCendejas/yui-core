...
import yui.audio.services.simple as simple
...
class TestSimpleBackend(unittest.TestCase):
    @mock.patch('yui.audio.services.simple.Session')
    ...
    @mock.patch('yui.audio.services.simple.play_mp3')
    @mock.patch('yui.audio.services.simple.play_ogg')
    @mock.patch('yui.audio.services.simple.play_wav')
