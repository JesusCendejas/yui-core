...
from yui.util import resolve_resource_file
...
class MustacheDialogRenderer:
    ...
    def __init__(self):
        ...
        # We cycle through lines in .dialog files to keep Yui from
    ...
    def render(self, template_name, context=None, index=None):
        ...
        Tries not to let Yui say exactly the same thing twice in a row.
