...
from yui.util import connected
...
class EnclosureGeneric(Enclosure):
    ...
    Yui Core.  This is used for Picroft or other headless systems,
    ...
    def __init__(self):
        ...
        self.bus.on('yui.skills.trained', self.is_device_ready)
    ...
    def is_device_ready(self, message):
        ...
        if is_ready:
            LOG.info("Yui is all loaded and ready to roll!")
            self.bus.emit(Message('yui.ready'))
