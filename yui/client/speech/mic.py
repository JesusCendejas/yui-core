...
class ResponsiveRecognizer(speech_recognition.Recognizer):
    ...
    def _upload_wakeword(self, audio, metadata):
        ...
        LOG.debug(
            ...
            "Yui-core v20.2 and below has been deprecated. To contribute "
    ...
    def listen(self, source, emitter, stream=None):
        """Listens for chunks of audio that Yui should perform STT on.
        ...
        # any, as we expect the user and Yui to not be talking.
