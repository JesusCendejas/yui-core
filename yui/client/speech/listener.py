...
from yui.client.speech.hotword_factory import HotWordFactory
from yui.client.speech.mic import MutableMicrophone, ResponsiveRecognizer
from yui.configuration import Configuration
from yui.metrics import MetricsAggregator, Stopwatch, report_timing
from yui.session import SessionManager
from yui.stt import STTFactory
from yui.util import connected
from yui.util.log import LOG
from yui.util import find_input_device
...
class AudioConsumer(Thread):
    ...
    def wake_up(self, audio):
        if self.wakeup_recognizer.found_wake_word(audio.frame_data):
            ...
            self.metrics.increment("yui.wakeup")
...
class RecognizerLoop(EventEmitter):
    ...
    def create_wake_word_recognizer(self):
        ...
        word = self.config.get('wake_word', 'hey yui')
