...
from yui.tts import TTSFactory
from yui.util import check_for_signal
from yui.util.log import LOG
from yui.messagebus.message import Message
from yui.tts.remote_tts import RemoteTTSException
...
def mimic_fallback_tts(utterance, ident, listen):
    ...
    Args:
        ...
        listen (bool): True if interaction should end with yui listening
    """
...
def handle_stop(event):
    ...
    if check_for_signal("isSpeaking", -1):
        ...
        bus.emit(Message("yui.stop.handled", {"by": "TTS"}))
...
def init(messagebus):
    ...
    Args:
        messagebus: Connection to the Yui messagebus
    """
    ...
    bus.on('yui.audio.speech.stop', handle_stop)
