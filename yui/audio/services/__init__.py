...
class AudioBackend(metaclass=ABCMeta):
    ...
    Args:
        ...
        bus (MessageBusClient): Yui messagebus emitter
    """
    ...
    def lower_volume(self):
        ...
        Yui is listening or speaking to make sure the media playing isn't
        interfering.
        """
    ...
    def restore_volume(self):
        ...
        Yui has lowered it using lower_volume().
        """
