...
class EnclosureAPI:
    ...
    that is running Yui.  It exposes all possible commands which
    can be sent to a Yui enclosure implementation.
    ...
    the eyes_color() API might be ignore on a Yui that uses simple
