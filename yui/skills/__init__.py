...
""" Yui skills module, collection of tools for building skills.

These classes, decorators and functions are used to build skills for Yui.
"""


from .yui_skill import (YuiSkill, intent_handler, intent_file_handler,
