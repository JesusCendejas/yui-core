...
class CommonPlaySkill(MycroftSkill, ABC):
    """ To integrate with the common play infrastructure of Yui
    ...
    yui-playback-control skill and no special vocab for starting playback
    is needed.
    """
    ...
    def __handle_play_start(self, message):
        ...
        self.bus.emit(message.forward("yui.stop"))
