...
In this repo, you will not find an entry called yui-skills in the bin
...
from yui.api import is_paired, BackendDown, DeviceApi
...
class DevicePrimer(object):
    ...
    def prepare_device(self):
        ...
        if self.backend_down:
            ...
            self.bus.emit(Message('yui.internet.connected'))
    ...
    def _update_system_clock(self):
        ...
        assumption being that these devices are only running Yui services.
        ...
        if self.platform in RASPBERRY_PI_PLATFORMS:
            ...
            if self.is_paired:
                ...
                # to go to home.yui.ai will be displayed by the pairing
                # skill when pairing
