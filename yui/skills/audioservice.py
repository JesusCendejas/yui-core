...
class AudioService:
    ...
    def queue(self, tracks=None):
        ...
        self.bus.emit(Message('yui.audio.service.queue',
                              data={'tracks': tracks}))
    ...
    def play(self, tracks=None, utterance=None, repeat=None):
        ...
        if isinstance(tracks, (str, tuple)):
            ...
            raise ValueError
        tracks = [ensure_uri(t) for t in tracks]
        self.bus.emit(Message('yui.audio.service.play',
                              data={'tracks': tracks,
                                    'utterance': utterance,
                                    'repeat': repeat}))
    ...
    def stop(self):
        """Stop the track."""
        self.bus.emit(Message('yui.audio.service.stop'))

    def next(self):
        """Change to next track."""
        self.bus.emit(Message('yui.audio.service.next'))

    def prev(self):
        """Change to previous track."""
        self.bus.emit(Message('yui.audio.service.prev'))

    def pause(self):
        """Pause playback."""
        self.bus.emit(Message('yui.audio.service.pause'))

    def resume(self):
        """Resume paused playback."""
        self.bus.emit(Message('yui.audio.service.resume'))
    ...
    def seek_forward(self, seconds=1):
        ...
        """
        self.bus.emit(Message('yui.audio.service.seek_forward',
                              {"seconds": seconds}))
    ...
    def seek_backward(self, seconds=1):
        ...
        """
        self.bus.emit(Message('yui.audio.service.seek_backward',
                              {"seconds": seconds}))
    ...
    def track_info(self):
        ...
        info = self.bus.wait_for_response(
            Message('yui.audio.service.track_info'),
            reply_type='yui.audio.service.track_info_reply',
            timeout=1)
    ...
    def available_backends(self):
        ...
        """
        msg = Message('yui.audio.service.list_backends')
