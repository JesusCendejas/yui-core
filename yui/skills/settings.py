...
SkillSettings Usage Example:
    from yui.skill.settings import SkillSettings
...
from yui.api import DeviceApi, is_paired
from yui.configuration import Configuration
from yui.messagebus.message import Message
from yui.util import camel_case_split
from yui.util.log import LOG
from yui.util.file_utils import ensure_directory_exists
...
class SettingsMetaUploader:
    ...
    application (https://account.yui.ai).
    """
    ...
    @property
    def msm(self):
        """Instance of the Yui Skills Manager"""
    ...
    def upload(self):
        """Upload the contents of the settingsmeta file to Yui servers.
...
REMOTE_CACHE = Path(xdg_cache_home, 'yui', 'remote_skill_settings.json')
