...
class SkillManager(Thread):
    ...
    def __init__(self, bus, watchdog=None):
        ...
        Args:
            bus (event emitter): Yui messagebus connection
    ...
    def _define_message_bus_events(self):
        ...
        self.bus.on('yui.paired', self.handle_paired)
        self.bus.on(
            'yui.skills.settings.update',
    ...
    def _load_on_startup(self):
        ...
        self.bus.emit(Message('yui.skills.initialized'))
    ...
    def send_skill_list(self, _):
        ...
        try:
            ...
            self.bus.emit(Message('yui.skills.list', data=message_data))
        except Exception:
