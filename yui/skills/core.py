...
#
""" Collection of core functions of the yui skills system.
...
import yui.skills.yui_skill as yui_skill
import yui.skills.fallback_skill as fallback_skill
from .yui_skill import *  # noqa


class MycroftSkill(yui_skill.MycroftSkill):
