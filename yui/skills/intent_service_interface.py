...
from yui.util import create_daemon
from yui.util.log import LOG


class IntentServiceInterface:
    """Interface to communicate with the Yui intent service.
...
class IntentQueryApi:
    ...
    def get_adapt_intent(self, utterance, lang="es-es"):
    ...
    def get_padatious_intent(self, utterance, lang="es-es"):
    ...
    def get_intent(self, utterance, lang="es-es"):
    ...
    def get_skill(self, utterance, lang="es-es"):
