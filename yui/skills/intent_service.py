...
#
"""Yui's intent service, providing intent parsing since forever!"""
from copy import copy
import time

from yui.configuration import Configuration, set_default_lf_lang
from yui.util.log import LOG
from yui.util.parse import normalize
...
class IntentService:
    """Yui intent service. parses utterances using a variety of systems.
    ...
    def __init__(self, bus):
        ...
        # Converse method
        self.bus.on('yui.speech.recognition.unknown', self.reset_converse)
        self.bus.on('yui.skills.loaded', self.update_skill_name_dict)
    ...
    def handle_utterance(self, message):
        """Main entrypoint for handling user utterances with Yui skills
