...
#
""" Message bus service for yui-core

The message bus facilitates inter-process communication between yui-core
processes. It implements a websocket server so can also be used by external
systems to integrate with the Yui system.
"""
import sys

from tornado import autoreload, web, ioloop

from yui.lock import Lock  # creates/supports PID locking file
from yui.messagebus.load_config import load_message_bus_config
from yui.messagebus.service.event_handler import MessageBusEventHandler
