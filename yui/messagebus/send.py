...
def main():
    ...
    if len(sys.argv) == 2:
        ...
        try:
            ...
            print("Ex: python -m yui.messagebus.send speak "
                  "'{\"utterance\" : \"hello\"}'")
            exit()
    else:
        print("Command line interface to the yui-core messagebus.")
        print("Usage: python -m yui.messagebus.send message")
        print("       python -m yui.messagebus.send message JSON-string\n")
        print("Examples: python -m yui.messagebus.send system.wifi.setup")
        print("Ex: python -m yui.messagebus.send speak "
              "'{\"utterance\" : \"hello\"}'")
        exit()
