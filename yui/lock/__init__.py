...
class Lock:  # python 3+ 'class Lock'
    ...
    The PID lock file is located in /tmp/yui/*.pid.  If another process
    ...
    def touch(self):
        """
        If needed, create the '/tmp/yui' directory than open the
