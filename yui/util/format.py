...
"""
The yui.util.format module provides various formatting functions for
...
def _duration_handler(time1, lang=None, speech=True, *, time2=None,
    ...
    Args:
        ...
        resolution (yui.util.format.TimeResolution, optional): lower bound

            yui.util.format.TimeResolution values:
    ...
    if time2:
        ...
        if type1 is not type2:
            ...
            warnings.formatwarning = lambda msg, * \
                args, **kwargs: "{}\n".format(msg)
            warning = ("WARN: yui.util.format.nice_duration_dt() can't "
