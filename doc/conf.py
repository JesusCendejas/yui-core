...
#
#
# Yui documentation build configuration file
#
import sys
import re
import os
...
latex_elements = {}
latex_documents = [
    (master_doc, 'Yui.tex', 'Yui Documentation',
...
man_pages = [
    (master_doc, 'yui', 'Yui Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Yui', 'Yui Documentation',
     author, 'Yui', 'Yui Artificial Intelligence Platform.',
     'Miscellaneous'),
]
